            ...
            <div class="collapse navbar-collapse" id="main-navbar">
                ...
                <div class="top-right links">
                    ...
                    @else
                        ...
                        <a class="btn btn-border" href="{{ route('login') }}">Login</a>
                ...
                <div class="contact-block">
                    ...
                    <form method="POST" action="{{url('postcontacs')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" placeholder="Email" name="email" class="form-control" name="email"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="submit-button">
                                    <button class="btn btn-common blush"  type="submit">Send Message</button>
