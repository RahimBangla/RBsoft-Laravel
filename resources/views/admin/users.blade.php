                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-custom spacing5">
                            <tbody>
                                ...
                                <tr>
                                    <td class="w60">
                                        <img src="../assets/images/xs/avatar6.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 rounded" data-original-title="Avatar Name">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="w60">
                                        <img src="../assets/images/xs/avatar7.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 rounded" data-original-title="Avatar Name">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="w60">
                                        <img src="../assets/images/xs/avatar8.jpg" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 rounded" data-original-title="Avatar Name">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="w60">
                                        <div class="avtar-pic w35 bg-indigo"><span>DA</span></div>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" title="">Sean Black</a>
                                        <p class="mb-0">+ 264-625-7262</p>
                                ...
                                <tr>
                                    <td class="w60">
                                        <div class="avtar-pic w35 bg-pink"><span>MS</span></div>
                                    </td>
                                    <td>
                                        <a href="javascript:void(0);" title="">Theresa Wright</a>
                                        <p class="mb-0">+ 264-625-2233</p>
